...
import { DollarSign, ShoppingCart, Package, Users, AlertTriangle, RefreshCw, Calendar, BarChart3 } from "lucide-react"
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (lowStockResponse.ok) {
        ...
        // Fallback to dummy data if API fails
        setLowStockProducts([
          { id: "1", name: "iPhone 15 Pro", quantityInStock: 2, minStockLevel: 5 },
          { id: "2", name: "Samsung Galaxy S24", quantityInStock: 1, minStockLevel: 3 },
          { id: "3", name: "MacBook Air M3", quantityInStock: 0, minStockLevel: 2 },
        ])
      }
    } catch (error) {
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              ...
              { action: "Product added", item: "iPhone 15 Pro", time: "15 minutes ago", type: "product" },
              { action: "Stock updated", item: "Samsung Galaxy S24", time: "1 hour ago", type: "inventory" },
              { action: "User login", user: "John Doe (Cashier)", time: "2 hours ago", type: "user" },
            ].map((activity, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">{activity.amount || activity.item || activity.user}</p>
                  </div>
                </div>
                <Badge variant="secondary" className="text-xs">
                  {activity.time}
